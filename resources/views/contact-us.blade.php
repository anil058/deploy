...
<head>
    ...
    <title>💥 Mansha Real - Contact Us</title>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-6 col-md-12 col-lg-6">
                                        ...
                                        <div><span><strong>Manshaa Real E-Commerce Pvt. Ltd.</strong></span></div>
                                        <div><span>info@manshaareal.com</span></div>
                                        <div><span>www.manshaareal.com</span></div>
                                        <hr class="d-sm-none d-md-block d-lg-none">
                                    </div>
                                    <div class="col-sm-6 col-md-12 col-lg-6">
                                        <h2 class="h4"><i class="fa fa-location-arrow"></i> Our Address</h2>
                                        <div><span><strong>Office Address</strong></span></div>
                                        <div><span>Mansa Real E-Commerce Pvt. Ltd. </span></div>
                                        <div><span>Ashram Road, Kumhar Toli, </span></div>
                                        <div><span>Hazaribag, Jharkhand - 825301 </span></div>
                                        <div><abbr data-toggle="tooltip" data-placement="top" title="Office Phone: 09546291136">O:</abbr> 09546291136</div>
                                        <hr class="d-sm-none">
                                    </div>
                                </div>
                            </div>
